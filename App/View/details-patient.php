        ...
        <div class="details">
           <p>Full Name: <span class="detail"><?php echo $data['fName'] . ' ' . $data['mName'] . ' ' . $data['lName']; ?></span></p>
            ...
            <?php
              ...
              '<a href="/patients/remove?id='.$data['id'].'" onclick="return confirm(\'Are you sure you want to delete this patient?\');">
  <div class="button remove"> <img src="/icon/c-delete-2.svg" /> Remove
  </div></a>';
            ?>
          </div>
        </div>
